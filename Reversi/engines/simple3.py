...
priority = {(0, 0): p6, (0, 1): p1, (0, 2): p5, (0, 3): p5, (0, 4): p5, (0, 5): p5, (0, 6): p1, (0, 7): p6, (1, 0): p1,
            (1, 1): p0, (1, 2): p2, (1, 3): p2, (1, 4): p2, (1, 5): p2, (1, 6): p0, (1, 7): p1, (2, 0): p5, (2, 1): p2,
            (2, 2): p4, (2, 3): p4, (2, 4): p4, (2, 5): p4, (2, 6): p2, (2, 7): p5, (3, 0): p5, (3, 1): p2, (3, 2): p4,
            (3, 3): p3, (3, 4): p3, (3, 5): p4, (3, 6): p2, (3, 7): p5, (4, 0): p5, (4, 1): p2, (4, 2): p4, (4, 3): p3,
            (4, 4): p3, (4, 5): p4, (4, 6): p2, (4, 7): p5, (5, 0): p5, (5, 1): p2, (5, 2): p4, (5, 3): p4, (5, 4): p4,
            (5, 5): p4, (5, 6): p2, (5, 7): p5, (6, 0): p1, (6, 1): p0, (6, 2): p2, (6, 3): p2, (6, 4): p2, (6, 5): p2,
            (6, 6): p0, (6, 7): p1, (7, 0): p6, (7, 1): p1, (7, 2): p5, (7, 3): p5, (7, 4): p5, (7, 5): p5, (7, 6): p1,
            (7, 7): p6}
...
class UCT(object):  # 父类
    def __init__(self, board, color, time_left=60, **kwargs):  # board:当前状态 color:下一步要走的人 time:规定时间
        self.board = board
        self.color = color
        ...
        self.calculation_time = time_left
    ...
    @staticmethod
    def is_end(board, state):  # 当前board,当前state,当前player
    ...
    def run_simulation(self):
        ...
        for t in xrange(1, self.max_actions + 1):
            ...
            actions_states = []  # actions_states = [(p, self.board.next_state(state, p)) for p in legal]
            # #当前状态下所有合法动作和下一个状态
            for act in legal:
...
class UCTWins(UCT):  # 按最终输赢评估
    ...
    def __init__(self, board, color, timeLeft=60, **kwargs):
        super(UCTWins, self).__init__(board, color, timeLeft, **kwargs)
...
class UCTValues(UCT):  # 按最终棋子数评估
    ...
    def __init__(self, board, color, timeLeft=60, **kwargs):
        super(UCTValues, self).__init__(board, color, timeLeft, **kwargs)
